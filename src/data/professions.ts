  ...
  // Engineering: Mechanical Engineer
  {
    ...
    translations: {
      en: {
        ...
        description: 'Mechanical engineers design, develop, build, and test mechanical and thermal devices, including tools, engines, and machines. They work across various industries to create solutions for mechanical systems.',
        tips: [
          'Highlight your mechanical engineering degree and certifications (PE, FE)',
          'Emphasize CAD software proficiency and technical skills',
          'Showcase mechanical design projects and innovations',
          'Include experience with manufacturing processes and materials',
          'Demonstrate knowledge of thermodynamics and mechanics'
        ],
        skills: [
        ...
        whyGood: [
          'Clear structure highlighting mechanical engineering expertise',
          'Emphasizes technical skills and CAD proficiency',
          'Shows practical project experience and results',
          'Demonstrates understanding of mechanical principles',
          'ATS-friendly format with engineering keywords'
        ]
      },
      nl: { name: 'Werktuigbouwkundig Ingenieur', slug: 'werktuigbouwkundig-ingenieur', description: 'Werktuigbouwkundigen ontwerpen, ontwikkelen, bouwen en testen mechanische en thermische apparaten, waaronder gereedschappen, motoren en machines. Ze werken in verschillende industrieën om oplossingen te creëren voor mechanische systemen.', tips: ['Benadruk je werktuigbouwkundige diploma en certificeringen', 'Leg nadruk op CAD-softwarevaardigheid en technische vaardigheden', 'Toon mechanische ontwerpprojecten en innovaties', 'Vermeld ervaring met productieprocessen en materialen', 'Demonstreer kennis van thermodynamica en mechanica'], skills: ['CAD-software (SolidWorks, AutoCAD, CATIA)', 'Thermodynamica en warmteoverdracht', 'Mechanisch ontwerp en analyse', 'FEA en simulatietools', 'Productieprocessen en materialen', 'Projectmanagement en documentatie', 'Probleemoplossing en innovatie'], whyGood: ['Duidelijke structuur die werktuigbouwkundige expertise benadrukt', 'Legt nadruk op technische vaardigheden en CAD-vaardigheid', 'Toont praktische projectervaring en resultaten', 'Demonstreert begrip van mechanische principes', 'ATS-vriendelijk formaat met engineeringtrefwoorden'] },
      fr: { name: 'Ingénieur Mécanique', slug: 'ingenieur-mecanique', description: 'Les ingénieurs mécaniques conçoivent, développent, construisent et testent des appareils mécaniques et thermiques, y compris des outils, des moteurs et des machines. Ils travaillent dans diverses industries pour créer des solutions pour les systèmes mécaniques.', tips: ['Mettez en avant votre diplôme d\'ingénieur mécanique et certifications', 'Soulignez la maîtrise des logiciels CAO et compétences techniques', 'Présentez des projets de conception mécanique et innovations', 'Incluez l\'expérience avec les processus de fabrication et matériaux', 'Démontrez la connaissance de la thermodynamique et de la mécanique'], skills: ['Logiciels CAO (SolidWorks, AutoCAD, CATIA)', 'Thermodynamique et transfert de chaleur', 'Conception et analyse mécanique', 'FEA et outils de simulation', 'Processus de fabrication et matériaux', 'Gestion de projet et documentation', 'Résolution de problèmes et innovation'], whyGood: ['Structure claire mettant en évidence l\'expertise en génie mécanique', 'Met l\'accent sur les compétences techniques et la maîtrise de la CAO', 'Montre l\'expérience pratique des projets et les résultats', 'Démontre la compréhension des principes mécaniques', 'Format compatible ATS avec mots-clés d\'ingénierie'] },
      es: { name: 'Ingeniero Mecánico', slug: 'ingeniero-mecanico', description: 'Los ingenieros mecánicos diseñan, desarrollan, construyen y prueban dispositivos mecánicos y térmicos, incluyendo herramientas, motores y máquinas. Trabajan en diversas industrias para crear soluciones para sistemas mecánicos.', tips: ['Destaca tu título de ingeniería mecánica y certificaciones', 'Enfatiza competencia en software CAD y habilidades técnicas', 'Muestra proyectos de diseño mecánico e innovaciones', 'Incluye experiencia con procesos de fabricación y materiales', 'Demuestra conocimiento de termodinámica y mecánica'], skills: ['Software CAD (SolidWorks, AutoCAD, CATIA)', 'Termodinámica y transferencia de calor', 'Diseño y análisis mecánico', 'FEA y herramientas de simulación', 'Procesos de fabricación y materiales', 'Gestión de proyectos y documentación', 'Resolución de problemas e innovación'], whyGood: ['Estructura clara que destaca experiencia en ingeniería mecánica', 'Enfatiza habilidades técnicas y competencia en CAD', 'Muestra experiencia práctica en proyectos y resultados', 'Demuestra comprensión de principios mecánicos', 'Formato compatible con ATS con palabras clave de ingeniería'] },
      de: { name: 'Maschinenbauingenieur', slug: 'maschinenbauingenieur', description: 'Maschinenbauingenieure entwerfen, entwickeln, bauen und testen mechanische und thermische Geräte, einschließlich Werkzeuge, Motoren und Maschinen. Sie arbeiten in verschiedenen Branchen, um Lösungen für mechanische Systeme zu schaffen.', tips: ['Heben Sie Ihren Maschinenbauabschluss und Zertifizierungen hervor', 'Betonen Sie CAD-Softwarekenntnisse und technische Fähigkeiten', 'Zeigen Sie mechanische Designprojekte und Innovationen', 'Fügen Sie Erfahrung mit Fertigungsprozessen und Materialien hinzu', 'Demonstrieren Sie Kenntnisse in Thermodynamik und Mechanik'], skills: ['CAD-Software (SolidWorks, AutoCAD, CATIA)', 'Thermodynamik und Wärmeübertragung', 'Mechanisches Design und Analyse', 'FEA und Simulationstools', 'Fertigungsprozesse und Materialien', 'Projektmanagement und Dokumentation', 'Problemlösung und Innovation'], whyGood: ['Klare Struktur, die Maschinenbauexpertise hervorhebt', 'Betont technische Fähigkeiten und CAD-Kompetenz', 'Zeigt praktische Projekterfahrung und Ergebnisse', 'Demonstriert Verständnis mechanischer Prinzipien', 'ATS-freundliches Format mit Ingenieurschlüsselwörtern'] },
      it: { name: 'Ingegnere Meccanico', slug: 'ingegnere-meccanico', description: 'Gli ingegneri meccanici progettano, sviluppano, costruiscono e testano dispositivi meccanici e termici, inclusi strumenti, motori e macchine. Lavorano in vari settori per creare soluzioni per sistemi meccanici.', tips: ['Evidenzia la tua laurea in ingegneria meccanica e certificazioni', 'Enfatizza la competenza in software CAD e competenze tecniche', 'Mostra progetti di design meccanico e innovazioni', 'Includi esperienza con processi di produzione e materiali', 'Dimostra conoscenza di termodinamica e meccanica'], skills: ['Software CAD (SolidWorks, AutoCAD, CATIA)', 'Termodinamica e trasferimento di calore', 'Progettazione e analisi meccanica', 'FEA e strumenti di simulazione', 'Processi di produzione e materiali', 'Gestione progetti e documentazione', 'Risoluzione problemi e innovazione'], whyGood: ['Struttura chiara che evidenzia competenza in ingegneria meccanica', 'Enfatizza competenze tecniche e competenza CAD', 'Mostra esperienza pratica su progetti e risultati', 'Dimostra comprensione dei principi meccanici', 'Formato compatibile con ATS con parole chiave di ingegneria'] },
      pl: { name: 'Inżynier Mechanik', slug: 'inzynier-mechanik', description: 'Inżynierowie mechanicy projektują, rozwijają, budują i testują urządzenia mechaniczne i termiczne, w tym narzędzia, silniki i maszyny. Pracują w różnych branżach, aby tworzyć rozwiązania dla systemów mechanicznych.', tips: ['Podkreśl swoje wykształcenie w zakresie inżynierii mechanicznej i certyfikaty', 'Podkreśl biegłość w oprogramowaniu CAD i umiejętności techniczne', 'Pokaż projekty projektowe mechaniczne i innowacje', 'Uwzględnij doświadczenie z procesami produkcyjnymi i materiałami', 'Wykazuj wiedzę z zakresu termodynamiki i mechaniki'], skills: ['Oprogramowanie CAD (SolidWorks, AutoCAD, CATIA)', 'Termodynamika i wymiana ciepła', 'Projektowanie i analiza mechaniczna', 'FEA i narzędzia symulacyjne', 'Procesy produkcyjne i materiały', 'Zarządzanie projektem i dokumentacja', 'Rozwiązywanie problemów i innowacje'], whyGood: ['Jasna struktura podkreślająca wiedzę w zakresie inżynierii mechanicznej', 'Kładzie nacisk na umiejętności techniczne i biegłość w CAD', 'Pokazuje praktyczne doświadczenie projektowe i wyniki', 'Wykazuje zrozumienie zasad mechanicznych', 'Format przyjazny dla ATS z kluczowymi słowami inżynieryjnymi'] },
      ro: { name: 'Inginer Mecanic', slug: 'inginer-mecanic', description: 'Inginerii mecanici proiectează, dezvoltă, construiesc și testează dispozitive mecanice și termice, inclusiv unelte, motoare și mașini. Ei lucrează în diverse industrii pentru a crea soluții pentru sisteme mecanice.', tips: ['Evidențiază diploma ta de inginerie mecanică și certificările', 'Subliniază competența în software CAD și abilitățile tehnice', 'Prezintă proiecte de design mecanic și inovații', 'Include experiența cu procesele de fabricație și materiale', 'Demonstrează cunoștințe de termodinamică și mecanică'], skills: ['Software CAD (SolidWorks, AutoCAD, CATIA)', 'Termodinamică și transfer de căldură', 'Proiectare și analiză mecanică', 'FEA și instrumente de simulare', 'Procese de fabricație și materiale', 'Managementul proiectelor și documentație', 'Rezolvarea problemelor și inovație'], whyGood: ['Structură clară care evidențiază expertiza în inginerie mecanică', 'Subliniază abilitățile tehnice și competența CAD', 'Arată experiență practică pe proiecte și rezultate', 'Demonstrează înțelegerea principiilor mecanice', 'Format compatibil cu ATS cu cuvinte cheie de inginerie'] },
      hu: { name: 'Gépészmérnök', slug: 'gepeszmernok', description: 'A gépészmérnökök terveznek, fejlesztenek, építenek és tesztelnek mechanikus és termikus eszközöket, beleértve szerszámokat, motorokat és gépeket. Különböző iparágakban dolgoznak mechanikai rendszerek megoldásainak létrehozásán.', tips: ['Hangsúlyozza gépészmérnöki diplomáját és tanúsítványait', 'Kiemeli a CAD szoftver jártasságot és műszaki készségeket', 'Mutassa be a mechanikai tervezési projekteket és innovációkat', 'Tartalmazza a gyártási folyamatokkal és anyagokkal kapcsolatos tapasztalatokat', 'Mutassa be a termodinamika és mechanika ismeretét'], skills: ['CAD szoftver (SolidWorks, AutoCAD, CATIA)', 'Termodinamika és hőátadás', 'Mechanikai tervezés és elemzés', 'FEA és szimulációs eszközök', 'Gyártási folyamatok és anyagok', 'Projektmenedzsment és dokumentáció', 'Problémamegoldás és innováció'], whyGood: ['Világos struktúra, amely kiemeli a gépészmérnöki szakértelmet', 'Hangsúlyozza a műszaki készségeket és CAD jártasságot', 'Mutatja a gyakorlati projekt tapasztalatot és eredményeket', 'Bemutatja a mechanikai elvek megértését', 'ATS-barát formátum mérnöki kulcsszavakkal'] },
      el: { name: 'Μηχανολόγος Μηχανικός', slug: 'michaanologos-michanikos', description: 'Οι μηχανολόγοι μηχανικοί σχεδιάζουν, αναπτύσσουν, κατασκευάζουν και δοκιμάζουν μηχανικές και θερμικές συσκευές, συμπεριλαμβανομένων εργαλείων, κινητήρων και μηχανών. Εργάζονται σε διάφορες βιομηχανίες για να δημιουργήσουν λύσεις για μηχανικά συστήματα.', tips: ['Επισημάνετε το πτυχίο μηχανολόγου μηχανικού και τις πιστοποιήσεις σας', 'Τονίστε την επάρκεια στο λογισμικό CAD και τις τεχνικές δεξιότητες', 'Παρουσιάστε έργα μηχανικού σχεδιασμού και καινοτομίες', 'Συμπεριλάβετε εμπειρία με διαδικασίες παραγωγής και υλικά', 'Αποδείξτε γνώση θερμοδυναμικής και μηχανικής'], skills: ['Λογισμικό CAD (SolidWorks, AutoCAD, CATIA)', 'Θερμοδυναμική και μεταφορά θερμότητας', 'Μηχανικός σχεδιασμός και ανάλυση', 'FEA και εργαλεία προσομοίωσης', 'Διαδικασίες παραγωγής και υλικά', 'Διαχείριση έργων και τεκμηρίωση', 'Επίλυση προβλημάτων και καινοτομία'], whyGood: ['Σαφής δομή που επισημαίνει την εμπειρογνωμοσύνη σε μηχανολογία', 'Τονίζει τις τεχνικές δεξιότητες και την επάρκεια στο CAD', 'Δείχνει πρακτική εμπειρία έργων και αποτελέσματα', 'Αποδεικνύει κατανόηση μηχανικών αρχών', 'Μορφή συμβατή με ATS με λέξεις-κλειδιά μηχανικής'] },
      cs: { name: 'Strojní Inženýr', slug: 'strojni-inzenyr', description: 'Strojní inženýři navrhují, vyvíjejí, staví a testují mechanická a tepelná zařízení, včetně nástrojů, motorů a strojů. Pracují v různých průmyslových odvětvích na vytváření řešení pro mechanické systémy.', tips: ['Zdůrazněte svůj titul strojního inženýra a certifikace', 'Zdůrazněte znalost CAD softwaru a technické dovednosti', 'Ukažte projekty mechanického designu a inovace', 'Zahrňte zkušenosti s výrobními procesy a materiály', 'Prokažte znalost termodynamiky a mechaniky'], skills: ['CAD software (SolidWorks, AutoCAD, CATIA)', 'Termodynamika a přenos tepla', 'Mechanický design a analýza', 'FEA a simulační nástroje', 'Výrobní procesy a materiály', 'Projektové řízení a dokumentace', 'Řešení problémů a inovace'], whyGood: ['Jasná struktura zdůrazňující odbornost ve strojním inženýrství', 'Zdůrazňuje technické dovednosti a znalost CAD', 'Ukazuje praktické zkušenosti s projekty a výsledky', 'Prokazuje porozumění mechanickým principům', 'Formát kompatibilní s ATS s inženýrskými klíčovými slovy'] },
      pt: { name: 'Engenheiro Mecânico', slug: 'engenheiro-mecanico', description: 'Engenheiros mecânicos projetam, desenvolvem, constroem e testam dispositivos mecânicos e térmicos, incluindo ferramentas, motores e máquinas. Trabalham em diversas indústrias para criar soluções para sistemas mecânicos.', tips: ['Destaque seu diploma de engenharia mecânica e certificações', 'Enfatize proficiência em software CAD e habilidades técnicas', 'Mostre projetos de design mecânico e inovações', 'Inclua experiência com processos de fabricação e materiais', 'Demonstre conhecimento de termodinâmica e mecânica'], skills: ['Software CAD (SolidWorks, AutoCAD, CATIA)', 'Termodinâmica e transferência de calor', 'Design e análise mecânica', 'FEA e ferramentas de simulação', 'Processos de fabricação e materiais', 'Gestão de projetos e documentação', 'Resolução de problemas e inovação'], whyGood: ['Estrutura clara destacando expertise em engenharia mecânica', 'Enfatiza habilidades técnicas e proficiência em CAD', 'Mostra experiência prática em projetos e resultados', 'Demonstra compreensão de princípios mecânicos', 'Formato compatível com ATS com palavras-chave de engenharia'] },
      sv: { name: 'Maskiningenjör', slug: 'maskiningenjo', description: 'Maskiningenjörer designar, utvecklar, bygger och testar mekaniska och termiska enheter, inklusive verktyg, motorer och maskiner. De arbetar inom olika branscher för att skapa lösningar för mekaniska system.', tips: ['Framhäv din maskiningenjörsexamen och certifieringar', 'Betona CAD-programvarukompetens och tekniska färdigheter', 'Visa mekaniska designprojekt och innovationer', 'Inkludera erfarenhet av tillverkningsprocesser och material', 'Visa kunskap om termodynamik och mekanik'], skills: ['CAD-programvara (SolidWorks, AutoCAD, CATIA)', 'Termodynamik och värmeöverföring', 'Mekanisk design och analys', 'FEA och simuleringsverktyg', 'Tillverkningsprocesser och material', 'Projektledning och dokumentation', 'Problemlösning och innovation'], whyGood: ['Tydlig struktur som framhäver maskiningenjörskompetens', 'Betonar tekniska färdigheter och CAD-kompetens', 'Visar praktisk projekterfarenhet och resultat', 'Visar förståelse för mekaniska principer', 'ATS-vänligt format med ingenjörsnyckelord'] },
      bg: { name: 'Машинен Инженер', slug: 'mashinen-inzhener', description: 'Машинните инженери проектират, разработват, изграждат и тестват механични и термични устройства, включително инструменти, двигатели и машини. Те работят в различни индустрии, за да създадат решения за механични системи.', tips: ['Подчертайте дипломата си по машинно инженерство и сертификатите', 'Акцентирайте върху компетентността в CAD софтуер и техническите умения', 'Покажете проекти за механичен дизайн и иновации', 'Включете опит с производствени процеси и материали', 'Демонстрирайте познания по термодинамика и механика'], skills: ['CAD софтуер (SolidWorks, AutoCAD, CATIA)', 'Термодинамика и топлопренос', 'Механичен дизайн и анализ', 'FEA и симулационни инструменти', 'Производствени процеси и материали', 'Управление на проекти и документация', 'Решаване на проблеми и иновации'], whyGood: ['Ясна структура, която подчертава експертизата в машинното инженерство', 'Акцентира върху техническите умения и компетентността в CAD', 'Показва практически опит по проекти и резултати', 'Демонстрира разбиране на механичните принципи', 'Формат, съвместим с ATS с инженерни ключови думи'] },
      da: { name: 'Maskiningeniør', slug: 'maskiningenior', description: 'Maskiningeniører designer, udvikler, bygger og tester mekaniske og termiske enheder, herunder værktøjer, motorer og maskiner. De arbejder i forskellige brancher for at skabe løsninger til mekaniske systemer.', tips: ['Fremhæv din maskiningeniørgrad og certificeringer', 'Fremhæv CAD-softwarekompetence og tekniske færdigheder', 'Vis mekaniske designprojekter og innovationer', 'Inkluder erfaring med produktionsprocesser og materialer', 'Vis viden om termodynamik og mekanik'], skills: ['CAD-software (SolidWorks, AutoCAD, CATIA)', 'Termodynamik og varmeoverførsel', 'Mekanisk design og analyse', 'FEA og simuleringsværktøjer', 'Produktionsprocesser og materialer', 'Projektledelse og dokumentation', 'Problemløsning og innovation'], whyGood: ['Tydelig struktur, der fremhæver maskiningeniørkompetence', 'Fremhæver tekniske færdigheder og CAD-kompetence', 'Vis praktisk projekterfaring og resultater', 'Vis forståelse af mekaniske principper', 'ATS-venligt format med ingeniørnøgleord'] },
      fi: { name: 'Koneinsinööri', slug: 'koneinsinoori', description: 'Koneinsinöörit suunnittelevat, kehittävät, rakentavat ja testaavat mekaanisia ja lämpölaitteita, mukaan lukien työkalut, moottorit ja koneet. He työskentelevät eri aloilla luomassa ratkaisuja mekaanisiin järjestelmiin.', tips: ['Korosta koneinsinöörin tutkintoa ja sertifikaatteja', 'Korosta CAD-ohjelmiston osaamista ja teknisiä taitoja', 'Näytä mekaanisia suunnitteluprojekteja ja innovaatioita', 'Sisällytä kokemusta valmistusprosesseista ja materiaaleista', 'Näytä termodynamiikan ja mekaniikan osaaminen'], skills: ['CAD-ohjelmisto (SolidWorks, AutoCAD, CATIA)', 'Termodynamiikka ja lämmönsiirto', 'Mekaaninen suunnittelu ja analyysi', 'FEA ja simulointityökalut', 'Valmistusprosessit ja materiaalit', 'Projektin hallinta ja dokumentointi', 'Ongelmanratkaisu ja innovaatio'], whyGood: ['Selkeä rakenne, joka korostaa koneinsinöörin asiantuntemusta', 'Korostaa teknisiä taitoja ja CAD-osaamista', 'Näyttää käytännön projektikokemuksen ja tulokset', 'Näyttää mekaanisten periaatteiden ymmärryksen', 'ATS-yhteensopiva muoto insinööriavainsanoilla'] },
      sk: { name: 'Strojný Inžinier', slug: 'strojny-inzinier', description: 'Strojní inžinieri navrhujú, vyvíjajú, stavajú a testujú mechanické a tepelné zariadenia, vrátane nástrojov, motorov a strojov. Pracujú v rôznych priemyselných odvetviach na vytváraní riešení pre mechanické systémy.', tips: ['Zdôraznite svoj titul strojného inžiniera a certifikácie', 'Zdôraznite znalosti CAD softvéru a technické zručnosti', 'Ukážte projekty mechanického dizajnu a inovácie', 'Zahrňte skúsenosti s výrobnými procesmi a materiálmi', 'Preukážte znalosti z termodynamiky a mechaniky'], skills: ['CAD softvér (SolidWorks, AutoCAD, CATIA)', 'Termodynamika a prenos tepla', 'Mechanický dizajn a analýza', 'FEA a simulačné nástroje', 'Výrobné procesy a materiály', 'Projektové riadenie a dokumentácia', 'Riešenie problémov a inovácie'], whyGood: ['Jasná štruktúra zdôrazňujúca odbornosť v strojnom inžinierstve', 'Zdôrazňuje technické zručnosti a znalosti CAD', 'Ukazuje praktické skúsenosti s projektmi a výsledky', 'Preukazuje porozumenie mechanickým princípom', 'Formát kompatibilný s ATS s inžinierskymi kľúčovými slovami'] },
      no: { name: 'Maskiningeniør', slug: 'maskiningenior', description: 'Maskiningeniører designer, utvikler, bygger og tester mekaniske og termiske enheter, inkludert verktøy, motorer og maskiner. De arbeider i ulike bransjer for å skape løsninger for mekaniske systemer.', tips: ['Fremhev din maskiningeniørgrad og sertifiseringer', 'Fremhev CAD-programvarekompetanse og tekniske ferdigheter', 'Vis mekaniske designprosjekter og innovasjoner', 'Inkluder erfaring med produksjonsprosesser og materialer', 'Vis kunnskap om termodynamikk og mekanikk'], skills: ['CAD-programvare (SolidWorks, AutoCAD, CATIA)', 'Termodynamikk og varmeoverføring', 'Mekanisk design og analyse', 'FEA og simuleringsverktøy', 'Produksjonsprosesser og materialer', 'Prosjektledelse og dokumentasjon', 'Problemløsning og innovasjon'], whyGood: ['Tydelig struktur som fremhever maskiningeniørkompetanse', 'Fremhever tekniske ferdigheter og CAD-kompetanse', 'Vis praktisk prosjekterfaring og resultater', 'Vis forståelse av mekaniske prinsipper', 'ATS-vennlig format med ingeniørnøkkelord'] },
