      ...
      <div className="flex-1 flex items-center justify-center px-6 pb-20">
        <div className="w-full max-w-[440px]">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-hk-dark">Welcome back</h1>
            <p className="text-slate-500 mt-2">Sign in to your HireKit account</p>
          </div>

          {registered && (
            <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-xl text-sm mb-6 text-center">
          ...
          <p className="mt-6 text-sm text-center text-slate-500">
            ...
            <Link href="/auth/signup" className="text-hk-primary font-semibold hover:text-[#4338CA] transition-colors">
              Sign up
            </Link>
          </p>
        </div>
